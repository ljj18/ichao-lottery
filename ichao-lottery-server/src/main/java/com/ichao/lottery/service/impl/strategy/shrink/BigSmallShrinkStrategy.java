 ...
 */
@Service
public class BigSmallShrinkStrategy implements IShrinkStrategy {

    @Override
    public boolean doShrink(P3Dto p3Dto, ShrinkConditionDto reqDto) {
        return matchCondition(reqDto.getBigSmall(), p3Dto.getBigSamll());
    }

    @Override
    public ShrinkStrategyType getShrinkType() {
        return ShrinkStrategyType.BIG_SMALL;
    }
