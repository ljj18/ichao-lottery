 ...
 */
@Service
public class OddEvenShrinkStrategy implements IShrinkStrategy {

    @Override
    public boolean doShrink(P3Dto p3Dto, ShrinkConditionDto reqDto) {
        return matchCondition(reqDto.getOddEven(), p3Dto.getOddEven());
    }

    @Override
    public ShrinkStrategyType getShrinkType() {
        return ShrinkStrategyType.ODD_EVEN;
    }
